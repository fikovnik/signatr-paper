...
1.2M new calls yielded only 20.4\% more coverage---while new code paths were explored, the extensive polymorphism and pervasiveness of coercion in R mean that most of these new calls did not exercise new R code.
